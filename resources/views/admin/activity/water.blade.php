    ...
    <table class="table">
        ...
        @foreach($activities['list'] as $activity)
            <tr>
                ...
                <td>
                    <textarea disabled="disabled" cols="100" rows="4" style="BORDER-BOTTOM: 0px solid; BORDER-LEFT: 0px solid; BORDER-RIGHT: 0px solid; BORDER-TOP: 0px solid;">{{$activity['content']}}</textarea>
                </td>
                <td>
